...
TARGET_BOOTLOADER_BOARD_NAME := Uv880p

BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true
BOARD_FORCE_STATIC_A2DP := true

BOARD_KERNEL_CMDLINE := androidboot.hardware=Uv880p console=null
...
BOARD_EGL_CFG := device/zte/Uv880p/prebuilt/lib/egl/egl.cfg
...
BOARD_CUSTOM_USB_CONTROLLER := ../../device/zte/Uv880p/UsbController.cpp
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING:= ../../device/zte/Uv880p/recovery/recovery_ui.c

# assert
TARGET_OTA_ASSERT_DEVICE := Uv880p,V880P,blade2
